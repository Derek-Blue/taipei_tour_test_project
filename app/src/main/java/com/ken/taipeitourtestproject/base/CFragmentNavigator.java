...
public class CFragmentNavigator extends Navigator<CFragmentNavigator.Destination> {
    ...
    public CFragmentNavigator(@NonNull Context context, @NonNull FragmentManager manager,
                             int containerId) {
        mContext = context;
    ...
    @NonNull
    @Override
    public CFragmentNavigator.Destination createDestination() {
        return new CFragmentNavigator.Destination(this);
    }
    ...
    @Nullable
    @Override
    public NavDestination navigate(@NonNull CFragmentNavigator.Destination destination, @Nullable Bundle args,
    ...
    public static class Destination extends NavDestination {
        ...
        public Destination(@NonNull NavigatorProvider navigatorProvider) {
            this(navigatorProvider.getNavigator(CFragmentNavigator.class));
        }

        public Destination(@NonNull Navigator<? extends CFragmentNavigator.Destination> fragmentNavigator) {
    ...
    public static final class Extras implements Navigator.Extras {
        ...
        public static final class Builder {
             ...
             */
            @NonNull
            public CFragmentNavigator.Extras.Builder addSharedElements(@NonNull Map<View, String> sharedElements) {
             ...
             */
            @NonNull
            public CFragmentNavigator.Extras.Builder addSharedElement(@NonNull View sharedElement, @NonNull String name) {
             ...
             */
            @NonNull
            public CFragmentNavigator.Extras build() {
                return new CFragmentNavigator.Extras(mSharedElements);
            }
        }
    }
}
