 ...
 */
public class CNavHostFragment extends Fragment implements NavHost {
...
//        dialogFragmentNavigator.onAttachFragment(childFragment);
    ...
    @Deprecated
    @NonNull
    protected Navigator<? extends CFragmentNavigator.Destination> createFragmentNavigator() {
        return new CFragmentNavigator(requireContext(), getChildFragmentManager(),
                getContainerId());
    }
